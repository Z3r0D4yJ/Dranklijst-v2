    ...
    <div className="h-screen flex flex-col overflow-hidden" style={{ background: 'var(--color-header)' }}>
      ...
      >
        <div className="mb-[18px]">
          <h2 className="text-[20px] font-extrabold tracking-[-0.4px] m-0 mb-1" style={{ color: 'var(--color-text-primary)' }}>Account aanmaken</h2>
          <p className="text-[13px] font-medium m-0" style={{ color: 'var(--color-text-muted)' }}>Registreer je voor Dranklijst</p>
        </div>
        ...
        <AuthGoogleButton
          ...
          label="Registreren met Google"
        />

        <p className="text-center text-[13px] font-medium mt-4" style={{ color: 'var(--color-text-muted)' }}>
          Al een account?{' '}
